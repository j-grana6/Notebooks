...
$\displaystyle \Pi_i(p_i, p_j) =  \begin{cases}        p_i-\theta & p_i<p_j, p_i<r \\\frac{p_i-\theta}{2} & p_i=p_j, p_i<r \\0 & \text{ otherwise }     \end{cases}$%
...
$\displaystyle r_i(p_i, p_j) =  \begin{cases}        p_i & p_i<p_j, p_i<r \\\frac{p_i}{2} & p_i=p_j, p_i<r \\0 & \text{ otherwise }     \end{cases}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
